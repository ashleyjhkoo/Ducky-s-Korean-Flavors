...
[Module03_Advanced](https://ashleyjhkoo.github.io/Responsive-Web-Programming-Modules/Module03_Advanced){:target="_blank"}


## What was the mission?
Create a responsive top menu bar along with the body content tables using Twitter Bootstrap CSS Framework with the improved solutions! (Completed the optional missions below.)
