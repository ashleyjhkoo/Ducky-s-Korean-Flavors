...
[Module03](https://ashleyjhkoo.github.io/Responsive-Web-Programming-Modules/Module03){:target="_blank"}


## What was the mission?
Create a responsive top menu bar along with the body content tables using Twitter Bootstrap CSS Framework!
